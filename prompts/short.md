...
- **Search first** with a focused `q`; use `limit` 10–25 unless breadth is needed. For **documents and file text**, always narrow with **`schemata:Pages`** (or **`schema:Pages`**)—this instance uses **`Pages`** for document retrieval.
