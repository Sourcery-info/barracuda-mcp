...
You can call **`aleph_search`** (Elasticsearch-style `q`, filters, pagination), **`aleph_get_entity`** (one entity by `id`), and **`aleph_get_entity_markdown`** (full body text for one entity).
