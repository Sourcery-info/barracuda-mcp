...
describe("formatAlephStructuredResponse", () => {
  it("returns a bare array of slim hits", () => {
    const result = formatAlephStructuredResponse(sample, { ...fmt(), query: "pat" });
